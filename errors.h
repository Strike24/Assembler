...
typedef enum
{
    ...
    ERROR_MACRO_EXTRA_CONTENT,
    ERROR_MACRO_DEC_EXTRA_CONTENT,
    ERROR_MEMORY_EXCEEDED,
    ERROR_LABEL_IS_EXTERNAL,
    ERROR_ENTRY_EMPTY_NAME,
    ERROR_EXTERN_EMPTY_NAME,
    ERROR_EXTRA_COMMA,
    ERROR_EXTRA_TEXT,
    ERROR_NO_OPERAND
} ErrorCode;
